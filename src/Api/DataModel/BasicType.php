...
abstract class BasicType implements BasicTypeInterface {
  ...
  protected function getDateTimeFromData($value) {
    ...
    elseif (is_numeric($value)) {
      ...
      // This checks if the resulting date is larger than expected (Friday, 11 June 2128)
      $far_far_future = 5000000000;
      if ($value > $far_future) {
